...
from ingest_data.plugins.jobs.download import DATASETS
from ingest_data.plugins.jobs.embed_and_store import DocumentEmbedder
from ingest_data.plugins.jobs.load_and_chunk import LoadAndChunk
from ingest_data.plugins.jobs.utils import check_src_data
...
if dataset_folder is None:
    raise ValueError("INLINE_DATA_VOLUME env var is not set")
...
def embed_and_store_data():
    ...
    _ = embedder.document_embedding_vectorstore(
